...
boundmask   <- sprawl::get_boundaries(in_country, level = 1) %>%
  ...
  sf::st_transform(get_proj4string("/home/lb/my_data/prasia/mosaics/ordered/decirc/full/eos_decirc.tif"))
...
a = plot_vect(datain, fill_var = "avg", borders = borders, leg_type = "qual", 
...
```{r, message=FALSE, warning=FALSE, eval = FALSE }
in_folder <- "/home/lb/my_data/prasia/mosaics/ordered/decirc/"
