...
#   library(rgdal)
#   library(raster)
#   rast<- raster('Y:/ermes/datasets/rs_products/Phenology/GR/Outputs/v4.0/2015/raster/old_min_identification_Full_Out_2015.dat')
#   out_res = 231.656358
...
#   writeOGR(sp_polygons,dsn = 'D:/Temp/PhenoRice/Processing/Validation_Ermes/GR/Accessory', layer = 'Grid_MODIS_250_reduced_gr', driver="ESRI Shapefile", overwrite_layer = T) #save the shapefile
#   gc()
# }
...
gr_grid_reduced = 'D:/Temp/PhenoRice/Processing/Validation_Ermes/GR/Accessory/Grid_MODIS_250_reduced_gr_red.shp'
...
gr_grid_reduced = file.path(out_folder,'Accessory','Grid_MODIS_250_reduced_gr_red.shp')
...
stats_14_15 = ddply(subset(protot_melt_14_15,counttot > 100), .(variable,Year) ,summarize, count = length(value),avg = mean(value, na.rm = T), stdev = sd(value, na.rm = T), mae = mean(abs(value),na.rm = T))

gr_250 = profull_14_15
gr_250_melt  = protot_melt_14_15
save(gr_250,gr_250_melt, file = 'd:/temp/phenorice/processing/Validation_Ermes/GR/GR_val_250.RData')
