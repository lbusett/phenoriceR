...
out_folder_shape = "/home/lb/ermes/data_processing/x_jrc/Shapefiles/%cc%/"
...
for (country in countries) {
  ...
  out_folder_shp = file.path(out_folder_shape_cc,"Shapefiles")
  ...
  aggr_data = lb_compute_pheno_stats(cc = cc, in_rast_ricemap = in_rast_ricemap ,in_rast_sow = sow_stack, in_rast_flw = flw_stack,
